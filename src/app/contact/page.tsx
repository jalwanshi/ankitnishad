...
const contactFormSchema = zod.object({
  ...
  agreeTerms: zod.boolean().refine((val) => val === true, {
    message: "You must accept the privacy policy & data transfer terms."
  })
});
...
function ContactFormInner() {
  ...
  // Parse query parameters to pre-fill fields
  useEffect(() => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
      ...
      <div className="lg:col-span-5 space-y-12">
        <div>
          <h3 className="font-display text-2xl font-light text-primary-black mb-4 uppercase tracking-wide">
        ...
        <div className="border border-border-grey bg-white p-8 space-y-4 max-w-[400px] rounded-xl">
          ...
          <a
            ...
            className="group inline-flex items-center gap-1.5 bg-primary-black text-white hover:bg-transparent hover:text-primary-black border border-primary-black px-4 py-2 text-xs font-sans uppercase tracking-widest transition-all duration-300 font-semibold rounded-lg"
          >
            Connect on LinkedIn
      ...
      <div className="lg:col-span-7 border border-border-grey bg-white p-8 md:p-12 rounded-2xl">
        {isSuccess ? (
          <div className="text-center py-20 space-y-6">
            ...
            <button
              ...
              className="inline-block border border-border-grey hover:border-primary-black px-5 py-2.5 text-xs font-sans uppercase tracking-widest text-muted-grey hover:text-primary-black transition-colors rounded-lg cursor-pointer"
            >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="border-b border-border-grey pb-4 mb-6">
              <h3 className="font-display text-xl font-normal text-primary-black uppercase tracking-wide">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col">
                ...
                <input
                  type="text"
                  {...register("fullName")}
                  className={`border bg-main-bg py-3 px-4 text-xs font-light focus:outline-none focus:border-primary-black transition-colors rounded-lg ${
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                {...register("challenge")}
                className={`border bg-main-bg py-3 px-4 text-xs font-light focus:outline-none focus:border-primary-black transition-colors resize-none rounded-lg ${
            ...
            <div className="space-y-2 pt-2">
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="agreeTerms" className="text-[10px] text-dark-grey leading-relaxed font-light select-none cursor-pointer">
                  I agree to the <Link href="/privacy-policy" target="_blank" className="underline hover:text-primary-black font-semibold">Privacy Policy & Terms of Service</Link>. I understand and agree that any business operational data or challenge details submitted on this form become the property of this website to be analyzed and processed. I also consent to receive email newsletter updates.
                </label>
              </div>
              {errors.agreeTerms && (
                <span className="text-[10px] text-red-500 block mt-1">{errors.agreeTerms.message}</span>
              )}
            </div>
            ...
            <button
              ...
              className="w-full bg-primary-black text-white hover:bg-transparent hover:text-primary-black border border-primary-black py-4 text-xs font-sans uppercase tracking-widest transition-all duration-300 font-bold rounded-xl disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
    ...
    <div className="min-h-screen bg-main-bg py-20 relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24 relative z-10">
        ...
        <div className="border-b border-border-grey pb-12 mb-16">
          ...
          <h1 className="font-display text-5xl md:text-7xl font-extralight text-primary-black tracking-tight uppercase">
            Let's Connect.
          </h1>
        </div>
        ...
        <Suspense fallback={
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <span className="text-xs uppercase tracking-widest text-muted-grey font-medium">Loading Form Setup...</span>
          </div>
        }>
          <ContactFormInner />
        </Suspense>
